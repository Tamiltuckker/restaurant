...
<div class="card">
    <div class="card-header">
        <div class="card-title flex-column">
            <h3 class="fw-boldest m-0">Tag List</h3>
        </div>
        
        <div class="card-toolbar">
             <div class="me-6 my-1">
             <a class="btn btn-sm btn-success" href="{{route('webadmin.tags.create')}}"> Create New Tag</a>
    ...
    <div class="card-body">
        ...
        <table id="kt_orders_classic" class="table table-row-bordered table-row-dashed g-3 gs-0 align-middle">
            <thead class="fs-7 fw-boldest text-gray-400 text-uppercase">
                <tr>
                    <th class="min-w-100px">tag Name</th>
            ...
            <tbody class="fs-6 fw-boldest">
              @foreach ($tags as $tag)
                <tr>
                    <td>{{$tag->name }}</td>
                    <td class="text-end">
                        <a href="{{route('webadmin.tags.edit',$tag->id)}}" class="btn btn-light btn-sm">Edit</a>
                       <form method="post" class="delete-form" data-route="{{route('webadmin.tags.destroy',$tag->id)}}">
                            @method('delete')
