...
<div class="card">
    <div class="card-header">
        <div class="card-title flex-column">
            <h3 class="fw-boldest m-0">Service List</h3>
        </div>
        
        <div class="card-toolbar">
             <div class="me-6 my-1">
             <a class="btn btn-sm btn-success" href="{{route('webadmin.services.create')}}"> Create New service</a>
            ...
            <tbody class="fs-6 fw-boldest">
              @foreach ($services as $service)
                <tr>
                    <td>
                        <div class="d-flex">
                            <div class="symbol symbol-75px me-6 bg-light">
                                <img src="{{asset('/storage/'.$service->image->attachmentable_image)}}"  alt="image" >
                            </div>
                        </div>
                    </td>
                    <td>{{$service->title }}</td>
                    ...
                    <td class="text-end">
                        <a href="{{route('webadmin.services.show',$service->id) }}" class="btn btn-light btn-sm me-2">View</a>
                         <a href="{{route('webadmin.services.edit',$service->id)}}" class="btn btn-light btn-sm">Edit</a>
                        <form method="post" class="delete-form" data-route="{{route('webadmin.services.destroy',$service->id)}}">
                            @method('delete')
