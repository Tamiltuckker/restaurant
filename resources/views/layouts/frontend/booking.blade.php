                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        {!! Form::open(['route' => 'booking.store','method' => 'post']) !!}
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                    {{ Form::select('people_count', $tables, NULL, ['class' => 'form-control form-control-solid form-select mb-2']) }}
                                        <label for="select1">Select No Of People</label>
                                      </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Special Request" name="details" id="message" style="height: 100px"></textarea>
