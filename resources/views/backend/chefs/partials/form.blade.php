...
<div class="fv-row row mb-15">
    <div class="col-md-3">
        {{ Form::label('designation', 'Designation', array('class' => 'fs-6 fw-bold mt-2')) }}
    </div>
    <div class="col-md-9">
    {{ Form::text('designation', old('designation'), ['class' => 'form-control form-control-solid','placeholder' => 'Designation']) }}
    </div>
</div>
...
<div class="row mt-12">
    <div class="col-md-9 offset-md-3">
        <a href="{{ route('webadmin.chefs.index') }}" class="btn btn-light me-3">Back</a>
