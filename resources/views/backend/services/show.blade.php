    ...
    <div class="card-body">
        <div class="d-flex align-items-start mb-7">
            <div class="overlay rounded overflow-hidden w-75px w-lg-125px flex-shrink-0 me-7">
                ...
                <img src="{{asset('/storage/'.$service->image->attachmentable_image)}}" alt="image" class="rounded w-100" height="30" width="50" />
                </div>
            </div>
            <div class="flex-grow-1 d-flex align-items-start justify-content-between flex-wrap py-24">
                <div class="d-flex flex-column align-items-start py-1 me-">
                    <div class="fs-3 text-dark text-hover-primary fw-boldest mb-2">{{ $service->title }}</div>
                    <div class="fs-3 text-dark text-hover-primary fw-boldest mb-2">{{ $service->description }}</div>
                </div>
            </div>
        </div>
    </div>
