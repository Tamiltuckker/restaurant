...
<div class="card">
    <div class="card-header">
        <div class="card-title flex-column">
            <h3 class="fw-boldest m-0">booking List</h3>
        </div>
        ...
        <table id="kt_orders_classic" class="table table-row-bordered table-row-dashed g-3 gs-0 align-middle">
            <thead class="fs-7 fw-boldest text-gray-400 text-uppercase">
                <tr>
                    ...
                    <th class="min-w-100px">People's Count</th>
            ...
            <tbody class="fs-6 fw-boldest">
              @foreach ($bookings as $booking)
                <tr>
                    ...
                    <td class="text-end">
                        <!-- <a href="{{route('webadmin.bookings.show',$booking->id) }}" class="btn btn-light btn-sm me-2">View</a> -->
                        <a href="{{route('webadmin.bookings.edit',$booking->id)}}" class="btn btn-light btn-sm">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
